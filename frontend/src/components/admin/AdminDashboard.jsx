...
const AdminDashboard = () => {
  ...
  // ======================================================
  // LOGOUT (kept for potential future use, no longer rendered here)
  // ======================================================
  ...
  return (
    <div className="min-h-screen bg-stone-50 font-sans">
      ...
      <main>
        ...
        <div className="relative bg-gradient-to-br from-orange-500 via-orange-600 to-amber-600 px-4 pb-8 pt-6 shadow-md sm:px-6 md:px-8">
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <h1 className="mt-1 text-2xl font-extrabold tracking-tight text-white sm:text-3xl md:text-4xl">
              Restaurant Dashboard
            </h1>
        ...
        <div className="mx-auto max-w-6xl space-y-8 px-4 pb-20 pt-6 sm:px-6 md:px-8">
