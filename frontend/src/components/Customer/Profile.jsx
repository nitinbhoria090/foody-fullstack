...
function Profile() {
  ...
  const handleAddressSubmit = async (e) => {
    ...
    try {
      ...
      const res = editingAddressId
        ? await API.put(`${import.meta.env.VITE_APP_API_URL}/address/${editingAddressId}`, addressForm, {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
            },
          })
        : await API.post(`${import.meta.env.VITE_APP_API_URL}/address/add`, addressForm, {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
            },
          });
  ...
  const handleDeleteAddress = async (id) => {
    try {
      const res = await API.delete(`${import.meta.env.VITE_APP_API_URL}/address/${id}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
        },
      });
